...
卖 出 成 功
卖 出 金额 993.97 元 于 04 月 30 日 15:30 到 账 余 额 宝
卖 出 信息
卖 出 产品 天 弘 中 证 电网 设备 主题 指数 C ~
卖 出 份额 730.00 份
...
到 账 金额 993.977T
到 财 渠 道 余额 宝
到 账 时 间 2026-04-30 15:30:22
订单 号 20260429001080012404790048444560
`;
      const result = parseTradeScreenshotText(sellText3);
      expect(result.success).toBe(true);
      expect(result.data).toEqual({
        fundName: '天弘中证电网设备主题指数C',
        operation: 'sell',
