// components/TradeSmartInputProgressModal.tsx
 ...
 * 交易智能输入进度窗口
 *
 * 参照SmartAddProgressModal设计，显示OCR处理进度
 */
export function TradeSmartInputProgressModal({
  visible,
  state,
  onComplete,
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
        <div className="px-5 py-4 border-b border-gray-100">
          <h3 className="text-base font-bold text-gray-800">交易智能录入处理进度</h3>
        </div>
